...
<head>
    ...
    <link href="footer.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
...
<div class="headeraligned">
	...
	<h2>ABOUT<span style="color: #72c02c;"> SB HOSPITAL </span></h2>
	</div>
	</div>		
			...
			<p><span style="color: #72c02c;">SB </span> Hospital  is a multi/super speciality hospital located at the prime location of Vaishnodevi Circle, SG Road, Bangalore; with state-of-the-art facilities & treatments at an affordable cost, encompassing wide spectrum of accurate diagnostics and elegant therapeutics created on the philosophical edifice of patient and ethical centricity ensuring humanistic dispensation.</p>
			...
			<!-- End About Section 1 -->
				...
				<!--=== End About Section 2===-->
						...
						<div class="line"></div>
						<p>SB Hospital is spread over a massive 6 acre campus <br/> providing<strong> 300+ </strong> beds and catering for nearly 45 super-specialties.</p>
						</div>
						...
						<h3>Cardiology</h3>
						<p>The department of cardiology at SB Hospital comprises of top cardiac experts who have appreciable experience in dealing with various types of cases in the cardiology and perform accurate diagnosis</p>
						</div>
						</div>
						</div>
						...
						<p>The dermatology department of SB Hospital consists of a team of dermatologists and staff who are practicing in the field of dermatology and cosmetology for years and perform their best to treat the patients.</p>
						</div>
						</div>
						</div>
						</div>
						...
						<p>At SB Hospital, 24x7 care is provided to all our patients, keeping in mind patient dignity and ethical practice. Holistic care is ensured by our team of critical care experts who use a multidisciplinary approach.</p>
						</div>
						</div>
						</div>
						<div class="col-sm-6" style="margin-bottom: 20px;">
						...
						<p>At SB Hospital, we have a team of experienced general surgeons who possess the skills to carry out the most complex surgeries.</p>
						</div>
						</div>
						</div>
						</div>
						...
						<p>SB Hospital provides health check up packages in Bangalore at very affordable price. As we aim at imbibing hope, health, and happiness in the community at large, our health check up packages in Bangalore help in early diagnosis.</p>
						</div>
						</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="service-block-desc">
						<h3>Neurology</h3>
						<p>The team at the Neurology department of SB Hospital comprises of highly-trained, skilled, and well-experienced team of Neurologists, Neurosurgeons, interventional radiologists, Neurophysiotherpists and rehabilitation teams who make sure that the patients receive the best quality treatments.</p>
						</div>
						</div>
						</div>
						</div>
