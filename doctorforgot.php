  ...
  if ($user == "" && $pass == "") {
...
else 
    {
        include('connection.php');
            ...
            $sql = "select * from doctor_login where username = '$username' and forgetkey = '$forgetkey'" ;
            ...
            if($count == 1){  
                $query = "update doctor_login set password='$password' where username='$username';";

                if (mysqli_query($connection, $query)) 
                {   
                    header("Location: alert6.html");
                }
            }  
            else{  
