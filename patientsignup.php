...
<head>
    ...
    <link href="style3.css?<?=filemtime("style3.css")?>" rel="stylesheet" type="text/css" />
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <form method="post">
          ...
          <div class="pass"><a href="loginforpatient.php">Login?</a></div>
          <div class="row button">
            <input type="submit" value="Change Password">
          <div class="signup-link">Not a member? <a href="patientsignup.php">Signup now</a></div>
          </div>
        </form>
      </div>
    </div>
  ...
  if ($user == "" && $pass == "") {
...
else 
    {
        include('connection.php');
            ...
            $sql = "select * from patient_login where username = '$username' and forgetkey = '$forgetkey'" ;
            ...
            if($count == 1){  
                $query = "update patient_login set password='$password' where username='$username';";

                if (mysqli_query($connection, $query)) 
                {   
                    header("Location: alert11.html");
                }
            }  
            else{  
                header("Location: alert12.html");
            }     
            }
        }
