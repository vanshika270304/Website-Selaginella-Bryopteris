    ...
    <div class="container">
      <div class="wrapper">
        ...
        <form method="post">
          ...
          <div class="pass"><a href="patientforgot.php">Forgot Password?</a></div>
  ...
  if ($user == "" && $pass == "") {
...
else 
    {
        include('connection.php');
            ...
            $sql = "select * from patient_login where username = '$username' and password = '$password'" ;
